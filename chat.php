...
<div id="session-name">
	...
	Your Username: <input type="text" value="<?= $_SESSION['user'] ?>" class="session-text" disabled>
</div>
...
<div id="form-container">
    <div class="form-text">
        <input type="text" style="display:none" id="username" name="username" value="<?= $_SESSION['user'] ?>">
        <textarea id="comment" name="comment"></textarea>
        <input type="hidden" id="group_id" name="group_id" value="<?= $_GET['id'];?>">
    </div>
    <div class="form-btn">

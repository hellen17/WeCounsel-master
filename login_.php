...
function counselor($mysqli,$user,$password){
	$result=$mysqli->query("select *from counselors where user ='$user' and password ='$password'") or die("failed to query database" .mysqli_error());
	$row=mysqli_fetch_array($result);
